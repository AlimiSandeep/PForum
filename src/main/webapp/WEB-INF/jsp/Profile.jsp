		...
		<div class="col">
			...
			<ul class="nav nav-tabs">
				...
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#questions">Ques. asked by me</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#answers">Answered by me</a></li>
			</ul>
			<div class="tab-content">
				<div id="profile" class="container tab-pane active"
					...
					<h3>
						Profile<span
							style="float: right; font-size: 20px; cursor: pointer;"></span> <!-- <a href="#" style="text-decoration:none;color:#9e9e9e;">edit</a></span> -->
					</h3>
					<c:set var="u" scope="session" value="${empinfo}"/> 
					<ul class="list-group">
						<li class="list-group-item">Name :${u.getFname()}</li>
						<li class="list-group-item">Email : ${u.getEmail()}</li>
						<li class="list-group-item">Designation : ${u.getDesig()}</li>
						<li class="list-group-item">Username : ${u.getUserName()}</li>
					</ul>
				</div>
				<div id="questions" class="container tab-pane fade">
					<br>
					<h3>Questions</h3>
					<div class="col">
						<c:forEach items="${allquesbyuser}" var="question">
							<div class="card post">
								<div class="user-info">
									<ul>
								...
								<div class="card-body question-body">
									...
									<p class="card-text question">
										<span style="font-size: 20px; font-weight: bold;">Ques.
										</span>${question.getQuestion()}</p>

									<!-- Answer button start -->

									<button type="button" class="btn answerbtn" data-toggle="modal"
										data-target="#answer${question.getQuestionId()}">Answer</button>
									<div id="answer${question.getQuestionId()}" class="modal fade"
										role="dialog">
									...
									<button type="button" class="btn reportbtn" data-toggle="modal"
										data-target="#report${question.getQuestionId()}">Report
										this question</button>
									<div id="report${question.getQuestionId()}" class="modal fade"
										role="dialog">
										<div class="modal-dialog modal-lg">
												...
												<div class="modal-body">
													<div class="list-group">
														...
														<li style="position: absolute; left: 58px;">
															<ul
																style="list-style: none; display: list-item; padding: 5px 15px; line-height: 1.4rem;">
																<c:set var="uCurrent" scope="session" value="${u}" />
									...
									<div class="list-group answers">
										<c:forEach items="${question.answers}" var="obj">
											<div class="list-group-item list-group-item-action">
												<span>Answered. </span>${obj.getAnswer()} <span>By ~
													${obj.getUsernameAnswer()}</span>&nbsp <span>${obj.getAnswerDate()}</span>
												<!-- Report button for answer -->
												<button type="button" class="report_button"
													data-toggle="modal"
													data-target="#reportAnswer${obj.getAnsId()}">Report</button>
											</div>
											<div id="reportAnswer${obj.getAnsId()}" class="modal fade"
												role="dialog">
												<div class="modal-dialog modal-lg">
				...
				<div id="answers" class="container tab-pane fade">
					...
					<div class="list-group answers">
						<div>
							...
							<c:forEach items="${allansbyuser}" var="ans">
							<div class="list-group-item list-group-item-action">
								
								<span>Answer.</span>${ans.getAnswer()}
								<br /> <span style="font-size: 10px; color: #9e9e9e;">
								Answerd on : </span><span>${ans.getAnswerDate()}</span>
							</div>
							</c:forEach>
						</div>
