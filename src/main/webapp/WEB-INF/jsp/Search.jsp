...
<c:set var="allRecentQues" scope="session" value="${allsearchQuestions}"/> 
<title>${allRecentQues.size()} result found !</title>
...
%>
	...
	<div class="col">
		...
		<c:when test="${fn:length(allRecentQues) == 0}">
			<div class="card post" style="padding:4px;"><h4>Zero result found!</h4></div>
			</c:when>
		<c:otherwise>  
